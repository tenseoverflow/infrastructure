...
Runs on Fedora Server 37. Podman containers and Cockpit + [File Sharing plugin](https://github.com/45Drives/cockpit-file-sharing) to manage it all. 
...
make containers all systemd unit files for easy management and updating
